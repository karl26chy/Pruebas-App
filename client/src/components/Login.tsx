...
import { GraduationCap, Key, Mail, Eye, EyeOff } from 'lucide-react';
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-q10-500/50 focus:border-q10-500 transition-colors"
                  placeholder="••••••••"
                />
